...
vu.face.ui.gestures.allChallenges = ['smile', 'eyeClose', 'lookLeft', 'lookRight']
// none

//---------------------------------------------------

vu.face.ui.gestures.circleSvg = function(color) { return "url('data:image/svg+xml;base64," +  btoa('<?xml version="1.0" encoding="utf-8"?><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 210 210" style="enable-background:new 0 0 210 210;" xml:space="preserve">' +
    '<g d="layer1" transform="translate(0,-87)"><circle style="fill:none;stroke:'+color+';stroke-width:13;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1" id="path14" cx="105" cy="192.07381" r="96.832855" /> </g></svg>') +"')"}
...
vu.face.ui.gestures.circleActive = vu.face.ui.gestures.circleSvg('#1DC600');
vu.face.ui.gestures.circleDetected = vu.face.ui.gestures.circleSvg('#88898a');
vu.face.ui.gestures.circleInactive = vu.face.ui.gestures.circleSvg('#000000');
...
vu.face.ui.gestures.resultsFeedbackTimeFrame = 1000;
vu.face.ui.gestures.resultsValidateTimeFrame = 2500;
...
vu.face.ui.gestures.gestureMach = function(data) {
    ...
    if (challenge === 'eyeRightClose') {
        ...
        if (actualGesture.indexOf('eyeBrowRightDown') > -1 && actualGesture.indexOf('eyeRightClose') > -1) { right = true }
    ...
    if (challenge === 'eyeLeftClose') {
        ...
        if (actualGesture.indexOf('eyeBrowLeftDown') > -1 && actualGesture.indexOf('eyeLeftClose') > -1) { left = true }
    ...
    if (challenge === 'none') {
        ...
        if (left === true && right === true && center === true){
            gestureMach = true
        }
    }
    return gestureMach
...
vu.face.ui.gestures.genChallenges = function() {
    ...
    vu.face.ui.gestures.challenges.pop();
    vu.face.ui.gestures.challenges.pop();
