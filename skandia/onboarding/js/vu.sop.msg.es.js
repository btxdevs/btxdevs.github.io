...
vu.sop.msg.userInputPlaceholder = "Correo de usuario"
vu.sop.msg.userSendBtn = "Iniciar"

vu.sop.msg.cameraDenied = "Acceso a la camara denegado o no hay camara";
vu.sop.msg.cameraAutoplayProtection = "Video Anti-Autoplay evito el acceso a la camara, por favor, deshabilitelo y reintente";
vu.sop.msg.cameraError = "Ocurrio un error no determinado accediendo a la camara, contacte al administrador";

vu.sop.msg.userError = "Ocurrio un error en el inicio de la registracion, por favor, reintente";
...
vu.sop.msg.addFrontDocumentComunicationError = "Ocurrio un error comunicandose con la API, por favor, reintente";
...
vu.sop.msg.addFrontApiErrorFrontAlreadyExist = "Ocurrio un error con la imagen, por favor, reintente";

vu.sop.msg.addBackDocumentFileUploadBottomMsg  = "Dorso del documento";
vu.sop.msg.addBackDocumentBottomMsg = "Dorso del documento";
vu.sop.msg.addBackDocumentComunicationError = "Ocurrio un error comunicandose con la API, por favor, reintente";
...
vu.sop.msg.addBackDocumentError = "Ocurrio un error en la imagen del dorso, por favor, reintente";
vu.sop.msg.addBackApiErrorAntiSpoofing = "No podemos autenticar el documento, por favor, reintente";
vu.sop.msg.addBackApiErrorFrontAlreadyExist = "Ocurrio un error con la imagen, por favor, reintente";

vu.sop.msg.facePoint = "Siga el punto con la cabeza";
vu.sop.msg.faceComunicationErrorRegister = "Error comunicandose con la API, por favor, reintente";
vu.sop.msg.faceComunicationErrorEndOperation = "Error comunicandose con la API, por favor, reintente"
vu.sop.msg.faceError = "Ocurrio un error no determinado, contacte al administrador";
vu.sop.msg.faceErrorUserNotExist = "Usuario no existe";
vu.sop.msg.faceErrorFailAuth = "Fallo de autenticacion, por favor, reintente";
...
vu.sop.msg.faceGesturesSmile = "Sonria hasta que el circulo se ponga verde";
vu.sop.msg.faceGesturesEyeClose = "Cierre los ojos hasta escuchar el bip";
vu.sop.msg.faceGesturesEyeRightClose = "Cierre el ojo derecho hasta que el circulo se ponga verde";
vu.sop.msg.faceGesturesEyeLeftClose = "Cierre el ojo izquierdo hasta que el circulo se ponga verde";
vu.sop.msg.faceGesturesLookLeft = "Mire ligeramente a la derecha hasta que el circulo se ponga verde";
vu.sop.msg.faceGesturesLookRight = "Mire ligeramente a la izquierda hasta que el circulo se ponga verde";
vu.sop.msg.faceGesturesNone = "Mire hacia adelante con un gesto neutral hasta que el circulo se ponga verde";


vu.sop.msg.endOpApiBadScore = "No supero las validaciones de identidad, por favor, reintente";
vu.sop.msg.endOpApiDocumentDataError = "Informacion del documento erronea, por favor, reintente";
vu.sop.msg.endOpApiDocumentBackFrontError = "La informacion entre el frente y dorso del documento no coincide, por favor, reintente";
vu.sop.msg.endOpApiDocumentBarcodeDoNotExist = "No se pudo leer el codigo de barras, por favor, reintente";
vu.sop.msg.endOpApiDocumentExpired = "Documento expirado, por favor, reintente";
vu.sop.msg.endOpApiPersonDataFail = "No se pudo analizar la informacion de la persona, por favor, reintente";
